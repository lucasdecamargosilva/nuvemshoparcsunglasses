(function () {
    ...
    // ===============================================
    const apiKey = "pl_live_6de94f4162fd07a516c5d6d5680c88f8b73bb766afaa755b914968b7a45703dc";
    ...
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/arcsunglasses-check-limit';
        ...
        <div id="q-modal-ia">
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-step-pix">
                        <h2>Prova Extra</h2>
                        <p class="q-pix-subtitle">Limite de 6 provas atingido.<br>Pague R$1 via PIX para mais uma:</p>
    ...
    function init() {
        ...
        async function _checkProvasRestantes() {
            ...
            try {
                ...
                const restantes = Math.max(0, 6 - used);
                if (restantes > 0) {
